...

{
    ...
    while (!bQuit)          // main loop
    {
        ...
        else
        {
            ...
            printf("Average speed = %4.1f; root mean speed = %4.1f; time = %d; scale = %lg; max%% = %lg%%    \r", avgspeed(Num, N)/200.0, avgsqrspeed(Num, N)/200.0, time, scale, 100*(double)Maxelement/((double)N*(double)time + 1.0));
